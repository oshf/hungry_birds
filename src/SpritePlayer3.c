...
void Update_SPRITE_PLAYER3() {
	...
	if (jump == 1)
		doJump3();
	if (KEY_PRESSED(J_UP) && jump == 0 && canJump == 0 && active == 0) {  // If Up is pressed and can jump and is alive
		jump = 1;
		canJump = 1;
