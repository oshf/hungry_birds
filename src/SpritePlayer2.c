...
void Update_SPRITE_PLAYER2() {
	...
	if (jump == 1)
		doJump2();
	if (KEY_PRESSED(J_B) && jump == 0 && canJump == 0 && active == 0) { // If B is pressed and can jump and is alive
		jump = 1;
		canJump = 1;
